    ...
    secties: [
      {
        ...
        alineas: [
          "PetanQ is een vrijwilligersinitiatief dat een centrale toernooikalender voor petanque in België aanbiedt. Voor vragen over dit privacybeleid of je persoonsgegevens kan je terecht op info@petanq.be.",
        ],
      },
      {
      ...
      },
      {
        ...
        alineas: [
          "PetanQ gebruikt geen advertentie- of trackingcookies. Je taalvoorkeur (NL/FR) wordt lokaal in je browser opgeslagen (localStorage) en nooit naar onze servers verzonden. Als je inlogt als moderator, gebruikt Supabase een noodzakelijk inlogcookie om je sessie te onthouden.",
        ],
      },
      {
        kop: "8. Jouw rechten",
    ...
    secties: [
      {
        ...
        alineas: [
          "PetanQ est une initiative bénévole qui propose un calendrier central des tournois de pétanque en Belgique. Pour toute question concernant cette politique de confidentialité ou vos données personnelles, contactez info@petanq.be.",
        ],
      },
      {
      ...
      },
      {
        ...
        alineas: [
          "PetanQ n'utilise aucun cookie publicitaire ou de suivi. Votre préférence linguistique (NL/FR) est enregistrée localement dans votre navigateur (localStorage) et n'est jamais envoyée à nos serveurs. Si vous vous connectez en tant que modérateur, Supabase utilise un cookie de connexion nécessaire pour mémoriser votre session.",
        ],
      },
      {
        kop: "8. Vos droits",

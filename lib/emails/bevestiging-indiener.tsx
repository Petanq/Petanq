...
export function BevestigingIndienerEmail({ taal, naam, datum, gemeente }: Props) {
  if (taal === "fr") {
    return (
      <EmailLayout titel="Votre tournoi a bien été reçu">
        ...
        <Text style={tekstStijl}>
          Un bénévole vérifiera votre demande sous 48 heures. Vous recevrez un e-mail dès que votre tournoi sera publié sur Petanque13.
        </Text>
      </EmailLayout>
    );
  }
  ...
  return (
    <EmailLayout titel="Jouw toernooi is ontvangen">
      ...
      <Text style={tekstStijl}>
        Een vrijwilliger bekijkt je aanmelding binnen 48 uur. Je ontvangt een e-mail zodra je toernooi op Petanque13 verschijnt.
      </Text>
    </EmailLayout>
  );
}

...
const nl = {
  ...
  lijst: {
    ...
    toernooiOpslaanTitel: "Wil je dit tornooi makkelijk terugvinden?",
    toernooiOpgeslagenTitel: "Dit tornooi staat in je lijst",
    toernooiOpslaanUitleg: "Sla het op onder 'Mijn tornooien' en noteer eventueel met wie je hebt afgesproken.",
    toernooiVerwijderenUitLijst: "Verwijderen uit mijn lijst",
...
const fr: typeof nl = {
  ...
  lijst: {
    ...
    toernooiOpslaanTitel: "Vous voulez retrouver ce tournoi facilement ?",
    toernooiOpgeslagenTitel: "Ce tournoi est dans votre liste",
    toernooiOpslaanUitleg: "Enregistrez-le dans 'Mes tournois' et notez éventuellement avec qui vous avez rendez-vous.",
    toernooiVerwijderenUitLijst: "Retirer de ma liste",

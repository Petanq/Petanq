...
const nl = {
  ...
  filters: {
    ...
    kwalificatie: "Kwalificatiesysteem",
    metKwalificatiedata: "Met kwalificatiedata",
  ...
  lijst: {
    ...
    kwalificatieTitel: "Kwalificatie — kies 1 van deze data",
  ...
  form: {
    ...
    opmerking: "Opmerking",
    kwalificatieData: "Kwalificatiedata (optioneel)",
    kwalificatieDataUitleg:
      "Heeft dit tornooi meerdere kwalificatiedata die naar 1 finale leiden (bv. een schiftingensysteem)? Voeg ze hier toe — de datum hierboven blijft de hoofddatum (bv. de finale).",
...
const fr: typeof nl = {
  ...
  filters: {
    ...
    kwalificatie: "Système de qualification",
    metKwalificatiedata: "Avec dates de qualification",
  ...
  lijst: {
    ...
    kwalificatieTitel: "Qualification — choisissez 1 de ces dates",
  ...
  form: {
    ...
    opmerking: "Remarque",
    kwalificatieData: "Dates de qualification (optionnel)",
    kwalificatieDataUitleg:
      "Ce tournoi a-t-il plusieurs dates de qualification menant à 1 finale (ex. un système d'éliminatoires) ? Ajoutez-les ici — la date ci-dessus reste la date principale (ex. la finale).",

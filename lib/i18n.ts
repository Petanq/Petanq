...
const nl = {
  ...
  lijst: {
    ...
    kwalificatieRondeBadge: "Kwalificatieronde",
    metFinale: "+ finale",
  ...
  match13Aanvraag: {
    ...
    introVervolg:
      "We breiden Match13 stap voor stap uit naar andere clubs. Vraag hieronder toegang aan voor jouw club — we bekijken elke aanvraag persoonlijk en nemen contact met je op.",
    kenmerkenTitel: "Wat kan het vandaag?",
    kenmerken: [
      "Mêlée, Doublet, Triplet en Kwartet, met automatische loting",
      "Poules met winnaars/verliezers/barrage, gevolgd door een knock-outpiramide",
      "Een live scherm voor in de zaal, met scores en pleinnummers",
      "Automatisch klassement, ook voor wie niet tot de piramide raakte",
    ],
    formTitel: "Toegang aanvragen",
    club: "Naam van je club",
    naam: "Jouw naam",
    email: "E-mailadres",
    telefoon: "Telefoonnummer (optioneel)",
    bericht: "Bericht (optioneel)",
    berichtHint: "Bv. hoeveel toernooien per jaar, welke speelvormen je meestal gebruikt, ...",
    versturen: "Aanvraag versturen",
    bezigMetVersturen: "Bezig met versturen...",
    verzonden: "Bedankt! We bekijken je aanvraag persoonlijk en nemen binnenkort contact met je op.",
    fout: "Er ging iets mis bij het versturen. Probeer het opnieuw.",
  },
  form: {
    ...
    jouwNaam: "Jouw naam",
    jouwNaamHint: "Zodat we weten wie dit tornooi aanmeldt, mocht er iets moeten gecorrigeerd worden.",
    datum: "Datum",
    uur: "Uur",
    ...
    kwalificatieOpmerking: "Bijzonderheid voor deze datum (optioneel, bv. \"enkel clubleden\")",
    ...
    foutDubbel: "Dit lijkt al in de kalender te staan — controleer hieronder of het om hetzelfde tornooi gaat:",
    knopTochVersturen: "Toch versturen — dit is een ander tornooi",
    foutOngeldigeInvoer:
  ...
  beheer: {
    ...
    toegangGroepProvincie: "Specifieke provincie",
    toegangGroepRegio: "Regio",
  ...
  match13: {
    ...
    toonOpExternScherm: "Toon op extern scherm",
    kiesScherm: "Kies een scherm",
    schermLabel: (n: number) => `Scherm ${n}`,
    schermAnnuleren: "Annuleren",
    popupGeblokkeerd: "Kon geen nieuw venster openen — sta pop-ups toe voor deze site en probeer opnieuw.",
    ...
    kampioenPiramideBLabel: "Winnaar Piramide B:",
    uitlegSpeelbaar:
    ...
    wisScore: "wis score",
    wintKnop: "Wint",
    startKnop: "▶ Start tijd",
    finaleLabel: "Finale",
    piramideA: "Piramide A",
    piramideB: "Piramide B",
    speelPiramideB: "Speel ook Piramide B (voor de verliezers uit de poules)?",
    hintPiramideB:
    ...
    eindklassementHeader: "Eindklassement",
    plaatsKolom: "Plaats",
    ...
    lijstTest: "Test",
    lijstAfgewerkt: "Afgewerkt",
    lijstGeenClub: "Geen club",
    lijstOrganisator: "Organisator",
    lijstOrganisatorPlaceholder: "Naam van organisator",
    lijstGeenOrganisator: "Geen organisator",
    sectieGepland: (n: number) => `Gepland (${n})`,
    sectieLopend: (n: number) => `Lopende tornooien (${n})`,
    sectieAfgewerkt: (n: number) => `Afgewerkt (${n})`,
    geenLopendeToernooien: "Geen lopende tornooien.",
    geplandeDatumLabel: "Gepland op",
    lijstMarkeerTest: "Markeer als test-tornooi",
    lijstMarkeerAfgewerkt: "Markeer als afgewerkt",
    ...
    labelOpeningsuren: "Openingsuren",
    ...
    aanvraagWeigerReden: "Reden (optioneel)",
    aanvraagWeigerBevestigen: "Bevestig weigering",
    aanvraagFout: "Goedkeuren mislukt — probeer opnieuw.",
...
const fr: typeof nl = {
  ...
  lijst: {
    ...
    kwalificatieRondeBadge: "Manche de qualification",
    metFinale: "+ finale",
  ...
  match13Aanvraag: {
    ...
    introVervolg:
      "Nous étendons Match13 pas à pas à d'autres clubs. Demandez l'accès ci-dessous pour votre club — nous examinons chaque demande personnellement et vous recontactons.",
    kenmerkenTitel: "Que peut-il faire aujourd'hui ?",
    kenmerken: [
      "Mêlée, Doublette, Triplette et Quadrette, avec tirage au sort automatique",
      "Poules avec gagnants/perdants/barrage, suivies d'une pyramide finale",
      "Un écran de salle en direct, avec les scores et les numéros de terrain",
      "Classement automatique, aussi pour ceux qui n'ont pas atteint la pyramide",
    ],
    formTitel: "Demander l'accès",
    club: "Nom de votre club",
    naam: "Votre nom",
    email: "Adresse e-mail",
    telefoon: "Numéro de téléphone (optionnel)",
    bericht: "Message (optionnel)",
    berichtHint: "P.ex. combien de tournois par an, quelles formules vous utilisez le plus souvent, ...",
    versturen: "Envoyer la demande",
    bezigMetVersturen: "Envoi en cours...",
    verzonden: "Merci ! Nous examinons votre demande personnellement et vous recontactons bientôt.",
    fout: "Une erreur s'est produite lors de l'envoi. Veuillez réessayer.",
  },
  form: {
    ...
    jouwNaam: "Votre nom",
    jouwNaamHint: "Pour savoir qui a soumis ce tournoi, au cas où quelque chose devrait être corrigé.",
    datum: "Date",
    uur: "Heure",
    ...
    kwalificatieOpmerking: "Particularité pour cette date (optionnel, ex. « membres du club uniquement »)",
    kwalificatieFinaleLabel: "Finale :",
    ...
    foutDubbel: "Celui-ci semble déjà figurer dans le calendrier — vérifiez ci-dessous s'il s'agit du même tournoi :",
    knopTochVersturen: "Envoyer quand même — c'est un autre tournoi",
    foutOngeldigeInvoer:
  ...
  beheer: {
    ...
    toegangGroepProvincie: "Province spécifique",
    toegangGroepRegio: "Région",
  ...
  match13: {
    ...
    toonOpExternScherm: "Afficher sur un écran externe",
    kiesScherm: "Choisir un écran",
    schermLabel: (n: number) => `Écran ${n}`,
    schermAnnuleren: "Annuler",
    popupGeblokkeerd: "Impossible d'ouvrir une nouvelle fenêtre — autorisez les pop-ups pour ce site et réessayez.",
    ...
    kampioenPiramideBLabel: "Vainqueur Pyramide B :",
    uitlegSpeelbaar:
    ...
    wintKnop: "Gagne",
    startKnop: "▶ Démarrer le temps",
    finaleLabel: "Finale",
    piramideA: "Pyramide A",
    piramideB: "Pyramide B",
    speelPiramideB: "Jouer aussi la Pyramide B (pour les perdants des poules) ?",
    hintPiramideB:
    ...
    eindklassementHeader: "Classement final",
    plaatsKolom: "Place",
    ...
    lijstTest: "Test",
    lijstAfgewerkt: "Terminé",
    lijstGeenClub: "Pas de club",
    lijstOrganisator: "Organisateur",
    lijstOrganisatorPlaceholder: "Nom de l'organisateur",
    lijstGeenOrganisator: "Pas d'organisateur",
    sectieGepland: (n: number) => `Planifiés (${n})`,
    sectieLopend: (n: number) => `Tournois en cours (${n})`,
    sectieAfgewerkt: (n: number) => `Terminés (${n})`,
    geenLopendeToernooien: "Aucun tournoi en cours.",
    geplandeDatumLabel: "Prévu le",
    lijstMarkeerTest: "Marquer comme tournoi test",
    lijstMarkeerAfgewerkt: "Marquer comme terminé",
    ...
    labelOpeningsuren: "Heures d'ouverture",
    ...
    aanvraagWeigerReden: "Raison (optionnel)",
    aanvraagWeigerBevestigen: "Confirmer le refus",
    aanvraagFout: "L'approbation a échoué — réessayez.",

...
C. Herhalende reeks: EXACT hetzelfde tornooi dat gewoon meerdere keren terugkomt op losse, onafhankelijke data — bv. "elke laatste vrijdag van de maand" gevolgd door een lijst kalenderdata, of een vaste maandelijkse/wekelijkse clubavond met meerdere data vermeld. Er is GEEN schifting/kwalificatie/finale-relatie tussen die data (dat onderscheidt dit van A) — het zijn gewoon dezelfde herhaling, keer op keer. Geef dit terug als evenveel APARTE items als er data staan (net als bij B: elk met eigen datum, kwalificatiedata/kwalificatie_uur op null), maar met naam_nl/naam_fr, clubnaam, categorie, formule, prijs enz. exact GELIJK voor elk item — het is dezelfde avond, enkel de datum verschilt. Voeg bij C dus NOOIT de maand of een volgnummer toe aan naam_nl/naam_fr (dus niet "Tornooi - oktober", "Tornooi - november", ...) — dat hoort enkel bij situatie B, waar de items ook inhoudelijk verschillen.
